...
#define CONFIG_BK_HCI_TASK_STACK_SIZE				600     //500
#endif

#ifndef CONFIG_BK_HCI_RECV_PRIO_TASK_STACK_SIZE
#define CONFIG_BK_HCI_RECV_PRIO_TASK_STACK_SIZE		(500)
#endif

#ifndef CONFIG_BK_HCI_RECV_TASK_STACK_SIZE
#define CONFIG_BK_HCI_RECV_TASK_STACK_SIZE			(700)
#endif

#ifndef CONFIG_BK_HCI_TASK_PRI
#define CONFIG_BK_HCI_TASK_PRI				(AOS_DEFAULT_APP_PRI - 14)//(AOS_DEFAULT_APP_PRI - 25)
#endif

#ifndef CONFIG_BK_HCI_RECV_PRIO_TASK_PRI
#define CONFIG_BK_HCI_RECV_PRIO_TASK_PRI	(AOS_DEFAULT_APP_PRI - 25)//(AOS_DEFAULT_APP_PRI - 16)
#endif

#ifndef CONFIG_BK_HCI_RECV_TASK_PRI
#define CONFIG_BK_HCI_RECV_TASK_PRI			(AOS_DEFAULT_APP_PRI - 16)//(AOS_DEFAULT_APP_PRI - 14)
#endif
