...
/**
 ****************************************************************************************
 * @brief Choose an appropriate offset according to the interval with a required bandwidth
 *
 * @param[in]     link_id     Link identifier
 * @param[in]     role        Role of the activity
 * @param[in]     interval    Activity interval (in slots)
 * @param[in]     bandwidth   Required bandwidth (in slots)
 ...
 ****************************************************************************************
 */
uint8_t sch_plan_bandwidth_compute(uint8_t link_id, uint8_t role, uint16_t interval, uint16_t bandwidth,
