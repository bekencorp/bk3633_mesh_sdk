 ...
 * </pre>
 */
#define EM_BLE_CNTL_ADDR   (0x00810000 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_LINKCNTL_ADDR   (0x00810002 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ISOLINKCNTL_ADDR   (0x00810004 + EM_BLE_CS_OFFSET)
...
// field definitions
#define EM_BLE_STREAML_LBL_MASK   ((uint16_t)0x0000F800)
#define EM_BLE_STREAML_LBL_LSB    11
#define EM_BLE_STREAML_LBL_WIDTH  ((uint16_t)0x00000005)
...
#define EM_BLE_STREAML_LBL_RST    0x0
...
__INLINE void em_ble_isolinkcntl_pack(int elt_idx, uint8_t streamllbl, uint8_t grouplbl, uint8_t isosyncmode, uint8_t isosyncen, uint8_t isotype)
{
    ASSERT_ERR((((uint16_t)streamllbl << 11) & ~((uint16_t)0x0000F800)) == 0);
    ...
    EM_BLE_WR(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)streamllbl << 11) | ((uint16_t)grouplbl << 8) | ((uint16_t)isosyncmode << 3) | ((uint16_t)isosyncen << 2) | ((uint16_t)isotype << 0));
}

__INLINE void em_ble_isolinkcntl_unpack(int elt_idx, uint8_t* streamllbl, uint8_t* grouplbl, uint8_t* isosyncmode, uint8_t* isosyncen, uint8_t* isotype)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);

    *streamllbl = (localVal & ((uint16_t)0x0000F800)) >> 11;
...
__INLINE uint8_t em_ble_isolinkcntl_streaml_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE void em_ble_isolinkcntl_streaml_lbl_setf(int elt_idx, uint8_t streamllbl)
{
    ASSERT_ERR((((uint16_t)streamllbl << 11) & ~((uint16_t)0x0000F800)) == 0);
    EM_BLE_WR(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x0000F800)) | ((uint16_t)streamllbl << 11));
}
 ...
 * </pre>
 */
#define EM_BLE_THRCNTL_RATECNTL_ADDR   (0x00810006 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_LEBDADDR_ADDR   (0x00810008 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_SYNCWL_ADDR   (0x0081000E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_SYNCWH_ADDR   (0x00810010 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CRCINIT0_ADDR   (0x00810012 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CRCINIT1_ADDR   (0x00810014 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_FILTPOL_RALCNTL_ADDR   (0x00810016 + EM_BLE_CS_OFFSET)
...
__INLINE void em_ble_filtpol_ralcntl_pack(int elt_idx, uint8_t filterpolicy, uint8_t peradvfilten, uint8_t localrpasel, uint8_t ralmode, uint8_t ralen)
{
    ...
    EM_BLE_WR(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)filterpolicy << 8) | ((uint16_t)peradvfilten << 3) | ((uint16_t)localrpasel << 2) | ((uint16_t)ralmode << 1) | ((uint16_t)ralen << 0));
}

__INLINE void em_ble_filtpol_ralcntl_unpack(int elt_idx, uint8_t* filterpolicy, uint8_t* peradvfilten, uint8_t* localrpasel, uint8_t* ralmode, uint8_t* ralen)
{
 ...
 * </pre>
 */
#define EM_BLE_HOPCNTL_ADDR   (0x00810018 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXRXCNTL_ADDR   (0x0081001A + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXDFCNTL_ADDR   (0x0081001C + EM_BLE_CS_OFFSET)
...
#define EM_BLE_DSWCNTL_MASK      ((uint16_t)0x000000C0)
#define EM_BLE_DSWCNTL_LSB       6
#define EM_BLE_DSWCNTL_WIDTH     ((uint16_t)0x00000002)
...
#define EM_BLE_DSWCNTL_RST       0x0
#define EM_BLE_DFSAMPCNTL_RST    0x0
#define EM_BLE_DFTYPE_RST        0x0
#define EM_BLE_DFFILTEREN_RST    0x0
#define EM_BLE_DFEN_RST          0x0

__INLINE void em_ble_rxdfcntl_pack(int elt_idx, uint8_t dfrspen, uint8_t dswcntl, uint8_t dfsampcntl, uint8_t dftype, uint8_t dffilteren, uint8_t dfen)
{
    ASSERT_ERR((((uint16_t)dfrspen << 8) & ~((uint16_t)0x00000100)) == 0);
    ASSERT_ERR((((uint16_t)dswcntl << 6) & ~((uint16_t)0x000000C0)) == 0);
    ...
    EM_BLE_WR(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)dfrspen << 8) | ((uint16_t)dswcntl << 6) | ((uint16_t)dfsampcntl << 4) | ((uint16_t)dftype << 2) | ((uint16_t)dffilteren << 1) | ((uint16_t)dfen << 0));
}

__INLINE void em_ble_rxdfcntl_unpack(int elt_idx, uint8_t* dfrspen, uint8_t* dswcntl, uint8_t* dfsampcntl, uint8_t* dftype, uint8_t* dffilteren, uint8_t* dfen)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);

    *dfrspen = (localVal & ((uint16_t)0x00000100)) >> 8;
    *dswcntl = (localVal & ((uint16_t)0x000000C0)) >> 6;
...
__INLINE uint8_t em_ble_rxdfcntl_dswcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE void em_ble_rxdfcntl_dswcntl_setf(int elt_idx, uint8_t dswcntl)
{
    ASSERT_ERR((((uint16_t)dswcntl << 6) & ~((uint16_t)0x000000C0)) == 0);
    EM_BLE_WR(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x000000C0)) | ((uint16_t)dswcntl << 6));
}
 ...
 * </pre>
 */
#define EM_BLE_RXWINCNTL_ADDR   (0x0081001E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ISOTXDESCPTR_ADDR   (0x00810020 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ISORXDESCPTR_ADDR   (0x00810022 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ACLTXDESCPTR_ADDR   (0x00810024 + EM_BLE_CS_OFFSET)
...
/**
 * @brief DFANTPATTCNTL register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *     15                DFRSP   0
 *  12:08         MAX_SAMP_CTE   0x0
 *  06:00      ANT_PATT_LENGTH   0x0
 * </pre>
 */
#define EM_BLE_DFANTPATTCNTL_ADDR   (0x00810026 + EM_BLE_CS_OFFSET)
#define EM_BLE_DFANTPATTCNTL_INDEX  0x00000013
#define EM_BLE_DFANTPATTCNTL_RESET  0x00000000

__INLINE uint16_t em_ble_dfantpattcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE void em_ble_dfantpattcntl_set(int elt_idx, uint16_t value)
{
    EM_BLE_WR(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, value);
}
...
#define EM_BLE_ANT_PATT_LENGTH_MASK   ((uint16_t)0x0000007F)
#define EM_BLE_ANT_PATT_LENGTH_LSB    0
#define EM_BLE_ANT_PATT_LENGTH_WIDTH  ((uint16_t)0x00000007)

#define EM_BLE_DFRSP_RST              0x0
#define EM_BLE_MAX_SAMP_CTE_RST       0x0
#define EM_BLE_ANT_PATT_LENGTH_RST    0x0

__INLINE void em_ble_dfantpattcntl_pack(int elt_idx, uint8_t dfrsp, uint8_t maxsampcte, uint8_t antpattlength)
{
    ASSERT_ERR((((uint16_t)dfrsp << 15) & ~((uint16_t)0x00008000)) == 0);
    ASSERT_ERR((((uint16_t)maxsampcte << 8) & ~((uint16_t)0x00001F00)) == 0);
    ASSERT_ERR((((uint16_t)antpattlength << 0) & ~((uint16_t)0x0000007F)) == 0);
    EM_BLE_WR(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)dfrsp << 15) | ((uint16_t)maxsampcte << 8) | ((uint16_t)antpattlength << 0));
}

__INLINE void em_ble_dfantpattcntl_unpack(int elt_idx, uint8_t* dfrsp, uint8_t* maxsampcte, uint8_t* antpattlength)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);

    *dfrsp = (localVal & ((uint16_t)0x00008000)) >> 15;
    *maxsampcte = (localVal & ((uint16_t)0x00001F00)) >> 8;
    *antpattlength = (localVal & ((uint16_t)0x0000007F)) >> 0;
}

__INLINE uint8_t em_ble_dfantpattcntl_dfrsp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE void em_ble_dfantpattcntl_dfrsp_setf(int elt_idx, uint8_t dfrsp)
{
    ASSERT_ERR((((uint16_t)dfrsp << 15) & ~((uint16_t)0x00008000)) == 0);
    EM_BLE_WR(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x00008000)) | ((uint16_t)dfrsp << 15));
}

__INLINE uint8_t em_ble_dfantpattcntl_max_samp_cte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE void em_ble_dfantpattcntl_max_samp_cte_setf(int elt_idx, uint8_t maxsampcte)
{
    ASSERT_ERR((((uint16_t)maxsampcte << 8) & ~((uint16_t)0x00001F00)) == 0);
    EM_BLE_WR(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x00001F00)) | ((uint16_t)maxsampcte << 8));
}

__INLINE uint8_t em_ble_dfantpattcntl_ant_patt_length_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000007F)) >> 0);
}

__INLINE void em_ble_dfantpattcntl_ant_patt_length_setf(int elt_idx, uint8_t antpattlength)
{
    ASSERT_ERR((((uint16_t)antpattlength << 0) & ~((uint16_t)0x0000007F)) == 0);
    EM_BLE_WR(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_DFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x0000007F)) | ((uint16_t)antpattlength << 0));
}

/**
 * @brief DFANTSWPTR register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  13:00       ANTENNA_ID_PTR   0x0
 * </pre>
 */
#define EM_BLE_DFANTSWPTR_ADDR   (0x00810028 + EM_BLE_CS_OFFSET)
#define EM_BLE_DFANTSWPTR_INDEX  0x00000014
#define EM_BLE_DFANTSWPTR_RESET  0x00000000

__INLINE uint16_t em_ble_dfantswptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_DFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE void em_ble_dfantswptr_set(int elt_idx, uint16_t value)
{
    EM_BLE_WR(EM_BLE_DFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, value);
}

// field definitions
#define EM_BLE_ANTENNA_ID_PTR_MASK   ((uint16_t)0x00003FFF)
#define EM_BLE_ANTENNA_ID_PTR_LSB    0
#define EM_BLE_ANTENNA_ID_PTR_WIDTH  ((uint16_t)0x0000000E)

#define EM_BLE_ANTENNA_ID_PTR_RST    0x0

__INLINE uint16_t em_ble_dfantswptr_antenna_id_ptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_DFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    ASSERT_ERR((localVal & ~((uint16_t)0x00003FFF)) == 0);
    return (localVal >> 0);
}

__INLINE void em_ble_dfantswptr_antenna_id_ptr_setf(int elt_idx, uint16_t antennaidptr)
{
    ASSERT_ERR((((uint16_t)antennaidptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
    EM_BLE_WR(EM_BLE_DFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (uint16_t)antennaidptr << 0);
}
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_ADDR   (0x0081002A + EM_BLE_CS_OFFSET)
#define EM_BLE_WINOFFSET_INDEX  0x00000015
 ...
 * </pre>
 */
#define EM_BLE_MINEVTIME_ADDR   (0x0081002A + EM_BLE_CS_OFFSET)
#define EM_BLE_MINEVTIME_INDEX  0x00000015
 ...
 * </pre>
 */
#define EM_BLE_MAXEVTIME_ADDR   (0x0081002C + EM_BLE_CS_OFFSET)
#define EM_BLE_MAXEVTIME_INDEX  0x00000016
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_ADDR   (0x0081002E + EM_BLE_CS_OFFSET)
#define EM_BLE_CONNINTERVAL_INDEX  0x00000017
 ...
 * </pre>
 */
#define EM_BLE_CHMAP0_ADDR   (0x0081002E + EM_BLE_CS_OFFSET)
#define EM_BLE_CHMAP0_INDEX  0x00000017
 ...
 * </pre>
 */
#define EM_BLE_CHMAP1_ADDR   (0x00810030 + EM_BLE_CS_OFFSET)
#define EM_BLE_CHMAP1_INDEX  0x00000018
 ...
 * </pre>
 */
#define EM_BLE_CHMAP2_ADDR   (0x00810032 + EM_BLE_CS_OFFSET)
#define EM_BLE_CHMAP2_INDEX  0x00000019
 ...
 * </pre>
 */
#define EM_BLE_RXMAXBUF_ADDR   (0x00810034 + EM_BLE_CS_OFFSET)
#define EM_BLE_RXMAXBUF_INDEX  0x0000001A
 ...
 * </pre>
 */
#define EM_BLE_RXMAXTIME_ADDR   (0x00810036 + EM_BLE_CS_OFFSET)
#define EM_BLE_RXMAXTIME_INDEX  0x0000001B
 ...
 * </pre>
 */
#define EM_BLE_SK_ADDR   (0x00810038 + EM_BLE_CS_OFFSET)
#define EM_BLE_SK_INDEX  0x0000001C
 ...
 * </pre>
 */
#define EM_BLE_ADV_BD_ADDR_ADDR   (0x00810038 + EM_BLE_CS_OFFSET)
#define EM_BLE_ADV_BD_ADDR_INDEX  0x0000001C
 ...
 * </pre>
 */
#define EM_BLE_PEER_RALPTR_ADDR   (0x00810038 + EM_BLE_CS_OFFSET)
#define EM_BLE_PEER_RALPTR_INDEX  0x0000001C
 ...
 * </pre>
 */
#define EM_BLE_ADV_BD_ADDR_TYPE_ADDR   (0x0081003E + EM_BLE_CS_OFFSET)
#define EM_BLE_ADV_BD_ADDR_TYPE_INDEX  0x0000001F
 ...
 * </pre>
 */
#define EM_BLE_AUXTXDESCPTR_ADDR   (0x00810040 + EM_BLE_CS_OFFSET)
#define EM_BLE_AUXTXDESCPTR_INDEX  0x00000020
 ...
 * </pre>
 */
#define EM_BLE_IV_ADDR   (0x00810048 + EM_BLE_CS_OFFSET)
#define EM_BLE_IV_INDEX  0x00000024
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_2M_ADDR   (0x00810042 + EM_BLE_CS_OFFSET)
#define EM_BLE_WINOFFSET_2M_INDEX  0x00000021
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_2M_ADDR   (0x00810044 + EM_BLE_CS_OFFSET)
#define EM_BLE_CONNINTERVAL_2M_INDEX  0x00000022
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_LR_ADDR   (0x00810046 + EM_BLE_CS_OFFSET)
#define EM_BLE_WINOFFSET_LR_INDEX  0x00000023
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_LR_ADDR   (0x00810048 + EM_BLE_CS_OFFSET)
#define EM_BLE_CONNINTERVAL_LR_INDEX  0x00000024
 ...
 * </pre>
 */
#define EM_BLE_TXWINOFFSET_ADDR   (0x00810050 + EM_BLE_CS_OFFSET)
#define EM_BLE_TXWINOFFSET_INDEX  0x00000028
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT0_ADDR   (0x00810050 + EM_BLE_CS_OFFSET)
#define EM_BLE_TXCCMPKTCNT0_INDEX  0x00000028
 ...
 * </pre>
 */
#define EM_BLE_EXTADVSTAT_ADDR   (0x00810052 + EM_BLE_CS_OFFSET)
#define EM_BLE_EXTADVSTAT_INDEX  0x00000029
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT1_ADDR   (0x00810052 + EM_BLE_CS_OFFSET)
#define EM_BLE_TXCCMPKTCNT1_INDEX  0x00000029
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT2_ADDR   (0x00810054 + EM_BLE_CS_OFFSET)
#define EM_BLE_TXCCMPKTCNT2_INDEX  0x0000002A
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT0_ADDR   (0x00810056 + EM_BLE_CS_OFFSET)
#define EM_BLE_RXCCMPKTCNT0_INDEX  0x0000002B
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT1_ADDR   (0x00810058 + EM_BLE_CS_OFFSET)
#define EM_BLE_RXCCMPKTCNT1_INDEX  0x0000002C
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT2_ADDR   (0x0081005A + EM_BLE_CS_OFFSET)
#define EM_BLE_RXCCMPKTCNT2_INDEX  0x0000002D
 ...
 * </pre>
 */
#define EM_BLE_EVTCNT_ADDR   (0x0081005C + EM_BLE_CS_OFFSET)
#define EM_BLE_EVTCNT_INDEX  0x0000002E
 ...
 * </pre>
 */
#define EM_BLE_EVTCNT_OFFSET0_ADDR   (0x0081005E + EM_BLE_CS_OFFSET)
#define EM_BLE_EVTCNT_OFFSET0_INDEX  0x0000002F
 ...
 * </pre>
 */
#define EM_BLE_EVTCNT_OFFSET1_ADDR   (0x00810060 + EM_BLE_CS_OFFSET)
#define EM_BLE_EVTCNT_OFFSET1_INDEX  0x00000030
 ...
 * </pre>
 */
#define EM_BLE_EVTCNT_OFFSET2_ADDR   (0x00810062 + EM_BLE_CS_OFFSET)
#define EM_BLE_EVTCNT_OFFSET2_INDEX  0x00000031
 ...
 * </pre>
 */
#define EM_BLE_ISOEVTCNTL_ADDR   (0x00810064 + EM_BLE_CS_OFFSET)
#define EM_BLE_ISOEVTCNTL_INDEX  0x00000032
 ...
 * </pre>
 */
#define EM_BLE_ISOTXRXCNTL_ADDR   (0x00810066 + EM_BLE_CS_OFFSET)
#define EM_BLE_ISOTXRXCNTL_INDEX  0x00000033
 ...
 * </pre>
 */
#define EM_BLE_TXRXDESCCNT_ADDR   (0x00810068 + EM_BLE_CS_OFFSET)
#define EM_BLE_TXRXDESCCNT_INDEX  0x00000034
 ...
 * </pre>
 */
#define EM_BLE_ISOTXRXPKTCNT_ADDR   (0x0081006A + EM_BLE_CS_OFFSET)
#define EM_BLE_ISOTXRXPKTCNT_INDEX  0x00000035
