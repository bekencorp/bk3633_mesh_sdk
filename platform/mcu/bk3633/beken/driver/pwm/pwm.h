...
#define PWM_POSE_CPEDG                               posPWM1_Reg0x0_pwm0_cpedg_sel  
#define PWM_POSE_CTNU                                posPWM1_Reg0x0_pwm0_ctnu_mod
...
#define REG_APB_BK_PWMn_CNT_ADDR(n)         (PWM_BASE + 0x08 + (3 * 0x04 * (n)))
