...
enum dbg_swdiag
{
    ...
    */
    ...
    /**
     ******************************************************************************************
     * @brief BANK 42 : ICO Driver
     ******************************************************************************************
     */
    DBG_SWDIAG_ICO                                   = 42,

    DBG_SWDIAG_ICO_SCHED_OFFSET                      = 0,
    DBG_SWDIAG_ICO_SCHED_MASK                        = 0x01,

    DBG_SWDIAG_ICO_START_OFFSET                      = 1,
    DBG_SWDIAG_ICO_START_MASK                        = 0x02,

    DBG_SWDIAG_ICO_END_OFFSET                        = 2,
    DBG_SWDIAG_ICO_END_MASK                          = 0x04,

    DBG_SWDIAG_ICO_RX_ISO_OFFSET                     = 3,
    DBG_SWDIAG_ICO_RX_ISO_MASK                       = 0x08,

    DBG_SWDIAG_ICO_TX_ISO_OFFSET                     = 4,
    DBG_SWDIAG_ICO_TX_ISO_MASK                       = 0x10,

    DBG_SWDIAG_ICO_CANCEL_OFFSET                     = 5,
    DBG_SWDIAG_ICO_CANCEL_MASK                       = 0x20,

    DBG_SWDIAG_ICO_PROG_OFFSET                       = 6,
    DBG_SWDIAG_ICO_PROG_MASK                         = 0x40,

    DBG_SWDIAG_ICO_SKIP_OFFSET                       = 7,
    DBG_SWDIAG_ICO_SKIP_MASK                         = 0x80,

    /**
     ******************************************************************************************
     * @brief BANK 43 : ICO Data Driver
     ******************************************************************************************
     */
    DBG_SWDIAG_ICO_DATA                              = 43,

    DBG_SWDIAG_ICO_DATA_PREPARE_TX_OFFSET            = 0,
    DBG_SWDIAG_ICO_DATA_PREPARE_TX_MASK              = 0x01,

    DBG_SWDIAG_ICO_DATA_PREPARE_RX_OFFSET            = 1,
    DBG_SWDIAG_ICO_DATA_PREPARE_RX_MASK              = 0x02,

    DBG_SWDIAG_ICO_DATA_PROG_TX_OFFSET               = 2,
    DBG_SWDIAG_ICO_DATA_PROG_TX_MASK                 = 0x04,

    DBG_SWDIAG_ICO_DATA_PROG_RX_OFFSET               = 3,
    DBG_SWDIAG_ICO_DATA_PROG_RX_MASK                 = 0x08,

    DBG_SWDIAG_ICO_DATA_COMP_SCHED_OFFSET            = 4,
    DBG_SWDIAG_ICO_DATA_COMP_SCHED_MASK              = 0x10,

    DBG_SWDIAG_ICO_DATA_COMP_SCHED_INT_OFFSET        = 5,
    DBG_SWDIAG_ICO_DATA_COMP_SCHED_INT_MASK          = 0x20,

    DBG_SWDIAG_ICO_DATA_COMP_SCHED_SEQ_OFFSET        = 6,
    DBG_SWDIAG_ICO_DATA_COMP_SCHED_SEQ_MASK          = 0x40,
    ...
    /**
     ******************************************************************************************
     * @brief BANK 45 : ICL Driver
     ******************************************************************************************
     */
    DBG_SWDIAG_ICL                                   = 45,

    DBG_SWDIAG_ICL_SCHED_OFFSET                      = 0,
    DBG_SWDIAG_ICL_SCHED_MASK                        = 0x01,

    DBG_SWDIAG_ICL_START_OFFSET                      = 1,
    DBG_SWDIAG_ICL_START_MASK                        = 0x02,

    DBG_SWDIAG_ICL_END_OFFSET                        = 2,
    DBG_SWDIAG_ICL_END_MASK                          = 0x04,

    DBG_SWDIAG_ICL_CANCEL_OFFSET                     = 3,
    DBG_SWDIAG_ICL_CANCEL_MASK                       = 0x08,

    DBG_SWDIAG_ICL_PROG_OFFSET                       = 4,
    DBG_SWDIAG_ICL_PROG_MASK                         = 0x10,

    DBG_SWDIAG_ICL_SKIP_OFFSET                       = 5,
    DBG_SWDIAG_ICL_SKIP_MASK                         = 0x20,

    DBG_SWDIAG_ICL_END_SCHED_OFFSET                  = 6,
    DBG_SWDIAG_ICL_END_SCHED_MASK                    = 0x40,

    DBG_SWDIAG_ICL_END_STREAM_OFFSET                 = 7,
    DBG_SWDIAG_ICL_END_STREAM_MASK                   = 0x80,
