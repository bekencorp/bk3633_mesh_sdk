...
{
    ble_coexifcntl0_wlcrxpriomode_setf(rxmode); /* set default/extended/priority mode for bt_rx */
    ble_coexifcntl0_wlctxpriomode_setf(txmode); /* set default/extended/priority mode for bt_tx */
    ble_coexifcntl0_wlantxmsk_setf(txmsk); /* wlan_tx impact on bt_tx/bt_rx (default mode = no impact) */
    ble_coexifcntl0_wlanrxmsk_setf(rxmsk); /* wlan_rx impact on bt_tx/bt_rx (default mode = can stop bt_tx) */
    ble_coexifcntl1_pack(rxthr /*wlcpRXthr*/, txthr /*wlcpTXthr*/, pduration /*wlcpduration*/, pdelay /*wlcpdelay*/); /* priority mode configuration */
}
