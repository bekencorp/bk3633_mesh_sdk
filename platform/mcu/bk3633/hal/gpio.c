...
static gpio_int_hdl gpio_int_hdls[GPIO_SUM];
...
static gpio_int_cb( uint8_t idx )
{
    void *arg = gpio_int_hdls[idx].arg;
    gpio_irq_handler_t cb_fn = gpio_int_hdls[idx].handler;
