...
export PATH
ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS   =-ggdb -fshort-enums -finline-small-functions -std=gnu99 -fshort-wchar -fms-extensions $(1) $(if $(filter yes,$(MXCHIP_INTERNAL) $(TESTER)),-Werror)
ADD_COMPILER_SPECIFIC_STANDARD_CXXFLAGS =-ggdb -fshort-enums -finline-small-functions -std=gnu99 -fshort-wchar -fms-extensions $(1) $(if $(filter yes,$(MXCHIP_INTERNAL) $(TESTER)),-Werror)
