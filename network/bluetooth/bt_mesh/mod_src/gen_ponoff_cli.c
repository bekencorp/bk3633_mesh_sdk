			  ...
			  struct mesh_net_buf_simple *buf)
{
	...
	enum bt_mesh_on_power_up on_power_up =mesh_net_buf_simple_pull_u8(buf);
				       ...
				       enum bt_mesh_on_power_up *rsp)
{
	...
	mesh_net_buf_simple_add_u8(&msg, on_power_up);
...
#endif /* CONFIG_BT_MESH_GEN_POWER_ONOFF_CLI */