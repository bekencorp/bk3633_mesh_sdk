...
GLOBAL_DEFINES += CONFIG_BT_MESH_HEALTH_SVR
...
GLOBAL_DEFINES += CONFIG_BT_MESH_LIGHT_BOARD
...
#GLOBAL_DEFINES += CONFIG_DEAULT_MESH_GROUP
GLOBAL_DEFINES += CONFIG_LIGHT_LED_FLASH

GLOBAL_DEFINES += CONFIG_INITIAL_OPTIMIZE
#GLOBAL_DEFINES += CONFIG_GENIE_FLASH_ENCRYPT
#GLOBAL_DEFINES += CONFIG_BLE_MESH_REDUCE_VOLTAGE_SLEEP
...
ifeq ($(network_change),1)
GLOBAL_DEFINES += CONFIG_NETWORK_CHANGE
#$(NAME)_SOURCES += 	uart_test_cmd.c
endif
