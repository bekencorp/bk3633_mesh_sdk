...
extern struct bt_mesh_model_pub g_time_srv_pub;
extern struct bt_mesh_model_pub g_scene_srv_pub;
extern struct bt_mesh_model_pub g_scheduler_pub;

#define MESH_MODEL_TIME_SRV(_user_data)      BT_MESH_MODEL(BT_MESH_MODEL_ID_TIME_SRV, \
                                                bt_mesh_time_srv_op, &g_time_srv_pub, _user_data)

#define MESH_MODEL_TIME_SETUP_SRV(_user_data) BT_MESH_MODEL(BT_MESH_MODEL_ID_TIME_SETUP_SRV, \
                                                  bt_mesh_time_setup_srv_op, NULL, _user_data)

#define MESH_MODEL_SCENE_SRV(_user_data)      BT_MESH_MODEL(BT_MESH_MODEL_ID_SCENE_SRV, \
                                                  bt_mesh_scene_srv_op, &g_scene_srv_pub, _user_data)

#define MESH_MODEL_SCENE_SETUP_SRV(_user_data) BT_MESH_MODEL(BT_MESH_MODEL_ID_SCENE_SETUP_SRV, \
                                                  bt_mesh_scene_setup_srv_op, &g_scene_srv_pub, _user_data)

#define MESH_MODEL_SCHEDULER_SRV(_user_data)       BT_MESH_MODEL(BT_MESH_MODEL_ID_SCHEDULER_SRV, \
                                                     bt_mesh_scheduler_srv_op, &g_scheduler_pub, _user_data)

#define MESH_MODEL_SCHEDULER_SETUP_SRV(_user_data) BT_MESH_MODEL(BT_MESH_MODEL_ID_SCHEDULER_SETUP_SRV, \
                                                    bt_mesh_scheduler_setup_srv_op, NULL, _user_data)
