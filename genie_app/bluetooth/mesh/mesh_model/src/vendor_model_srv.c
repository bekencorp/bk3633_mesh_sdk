...
{
    printf("++++++ %s ++++++\n", __func__);
    return  _vendor_model_analyze(model, ctx, buf, VD_HW_ATTR_GET);
}
...
{
    printf("++++++ %s +++++++\n", __func__);
    return  _vendor_model_analyze(model, ctx, buf, VD_HW_ATTR_SET);
}
...
{
    printf("+++++++ %s +++++++\n", __func__);
    return  _vendor_model_analyze(model, ctx, buf, VD_HW_ATTR_SET_NOACK);
}
...
////    { BT_MESH_MODEL_OP_3(VENDOR_OP_C7_INDICATE, CONFIG_CID_JX), 1, _vendor_model_C7_ack },
	...
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_GET, CONFIG_MESH_VENDOR_COMPANY_ID), 2, _vendor_model_get },
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_SET, CONFIG_MESH_VENDOR_COMPANY_ID), 2, _vendor_model_set_ack },
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_SET_NOACK, CONFIG_MESH_VENDOR_COMPANY_ID), 2, _vendor_model_set_unack },
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_SET_STATUS, CONFIG_MESH_VENDOR_COMPANY_ID), 2, NULL },
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_NOTIFY, CONFIG_MESH_VENDOR_COMPANY_ID), 1, NULL },
	{ BT_MESH_MODEL_OP_3(VD_HW_ATTR_NOTIFY_STATUS, CONFIG_MESH_VENDOR_COMPANY_ID), 1, JX_vendor_rec },
